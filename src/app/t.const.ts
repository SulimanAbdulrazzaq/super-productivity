const T = {
  ...
  GCF: {
    ...
    MISC: {
      ...
      LOCAL_REST_API_TOGGLE_ERROR: 'GCF.MISC.LOCAL_REST_API_TOGGLE_ERROR',
      LOCAL_REST_API_STATUS_LISTENING: 'GCF.MISC.LOCAL_REST_API_STATUS_LISTENING',
      LOCAL_REST_API_STATUS_PORT_IN_USE: 'GCF.MISC.LOCAL_REST_API_STATUS_PORT_IN_USE',
      LOCAL_REST_API_STATUS_PERMISSION_DENIED:
        'GCF.MISC.LOCAL_REST_API_STATUS_PERMISSION_DENIED',
      LOCAL_REST_API_STATUS_ERROR: 'GCF.MISC.LOCAL_REST_API_STATUS_ERROR',
      IS_ASSISTANT_ACCESS_ENABLED: 'GCF.MISC.IS_ASSISTANT_ACCESS_ENABLED',
      IS_ASSISTANT_ACCESS_ENABLED_HINT: 'GCF.MISC.IS_ASSISTANT_ACCESS_ENABLED_HINT',
      ASSISTANT_ACCESS_PERMISSIONS: 'GCF.MISC.ASSISTANT_ACCESS_PERMISSIONS',
      ASSISTANT_ACCESS_SCOPE_READ: 'GCF.MISC.ASSISTANT_ACCESS_SCOPE_READ',
      ASSISTANT_ACCESS_SCOPE_READ_NOTES: 'GCF.MISC.ASSISTANT_ACCESS_SCOPE_READ_NOTES',
      ASSISTANT_ACCESS_SCOPE_CAPTURE: 'GCF.MISC.ASSISTANT_ACCESS_SCOPE_CAPTURE',
      ASSISTANT_ACCESS_KEY: 'GCF.MISC.ASSISTANT_ACCESS_KEY',
      ASSISTANT_ACCESS_KEY_GENERATE: 'GCF.MISC.ASSISTANT_ACCESS_KEY_GENERATE',
      ASSISTANT_ACCESS_KEY_REPLACE: 'GCF.MISC.ASSISTANT_ACCESS_KEY_REPLACE',
      ASSISTANT_ACCESS_KEY_SHOWN_ONCE: 'GCF.MISC.ASSISTANT_ACCESS_KEY_SHOWN_ONCE',
      ASSISTANT_ACCESS_KEY_EXISTS: 'GCF.MISC.ASSISTANT_ACCESS_KEY_EXISTS',
      ASSISTANT_ACCESS_SETUP: 'GCF.MISC.ASSISTANT_ACCESS_SETUP',
      ASSISTANT_ACCESS_SETUP_CLAUDE_CODE: 'GCF.MISC.ASSISTANT_ACCESS_SETUP_CLAUDE_CODE',
      ASSISTANT_ACCESS_SETUP_JSON: 'GCF.MISC.ASSISTANT_ACCESS_SETUP_JSON',
      ASSISTANT_ACCESS_SAVE_ERROR: 'GCF.MISC.ASSISTANT_ACCESS_SAVE_ERROR',
